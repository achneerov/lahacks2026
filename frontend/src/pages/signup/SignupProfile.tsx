    ...
    function onKey(e: KeyboardEvent) {
      ...
      if (isQuickFillShortcut) {
        ...
        setForm({
          ...
          work_experience: [{ job_title: 'Software Engineer', company: 'TechCorp', city: 'San Francisco', state: 'CA', employment_type: 'FullTime', start_date: '2022-01', end_date: '', current_job: true, responsibilities: 'Full-stack development with React and Node.js APIs backed by PostgreSQL; SQL and schema design for relational data', key_achievements: 'Led migration to TypeScript' }],
          ...
          skills: [{ skill: 'TypeScript', proficiency: 'Advanced', years: 4 }, { skill: 'React', proficiency: 'Advanced', years: 4 }, { skill: 'PostgreSQL', proficiency: 'Proficient', years: 2 }],
